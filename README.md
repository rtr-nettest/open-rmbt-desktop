...
| `HISTORY_EXPORT_PATH`          | A path on the statistics server used to export history as a PDF file. Once the file is downloaded, a dialog will be shown for the user to pick the folder where to save it.                            |
| `HISTORY_SEARCH_PATH`          | A path on the statistics server used to export history as a CSV or XSLX file. Once the file is downloaded, a dialog will be shown for the user to pick the folder where to save it.                    |
