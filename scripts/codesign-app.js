...
async function collectAppsToSign(filePath) {
    ...
    for (const file of dir) {
        ...
        if (fullPathToFile.includes("jspawnhelper")) {
            console.log("RTR-Netztest CLI manual sign - ", fullPathToFile)
        ...
        if (isAppOrFramework) {
            ...
            if (fullPathToFile.includes("RTR-Netztest.app")) {
                    console.log("RTR-Netztest CLI sign - ", fullPathToFile)
                    appsToSign.push(fullPathToFile)
            }
            // sign app
            else {
                appsToSign.push(fullPathToFile)
                console.log("RTR-Netztest UI sign - ", fullPathToFile)
            }
        }
        if (isDirectory) {
